...
const translations = {
    ja: {
        ...
        precautionsTitle: "注意事項", precaution1: "やまそーの発信する情報はすべて正しいとは限りません。重要な情報は確認するようにしてください。", precaution2: "このチャットはあなたのみが見ることができます。", precaution3: "ChatYMSは0から設計されました。表示画面や内容に不具合がある場合は、下記のフォームにてお知らせください。", precaution4: "https://forms.gle/AuJavwYX333NXNYm6",
